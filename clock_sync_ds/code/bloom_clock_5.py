...
def event(pid,counter,eid):
    ...
    with open('bloom_poset_5.txt', 'a') as outfile:
...
def process_three(pipe31,pipe32):
    ...
    counter = send_message(pipe31,pid,counter,'i')
...
def process_four(pipe41):
    ...
    counter = recv_message(pipe41,pid,counter,'k')
...
if __name__ == '__main__':
    ...
    poset = {}
    with open('bloom_poset_5.txt') as json_file:
